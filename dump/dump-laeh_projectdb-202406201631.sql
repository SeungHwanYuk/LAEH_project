...
('2','HEALTH',NULL,'Sun','yami2024','https://i.ibb.co/x2tbpdj/profile03.jpg'),
...
('bobo','2024-06-14 11:14:59.956055','$2a$10$w0nEI4NT/WnXuHNGDbvcR.0PuAF/bM9InX6ZLi6QRo9ZcoRoZ.wwO','012121212','iambobo@email.com','bobo','bobo','ROLE_USER','WOMEN'),
...
('star0717','2024-06-10 16:15:05.868515','$2a$10$3LAOYW3QHxc4mIjgBJO5.uDddmyZlBbDJXUx0QOIN51FSAr9VA36G','012121212','iamstar@email.com','star0717','byul','ROLE_USER','WOMEN'),
('yami','2024-06-20 16:19:21.580774','$2a$10$MA4hFL0lRJiuZ/7I3X.pBuituH2ss/e/3HHBJ/OnetOGXIhbbX4PC','123','ya@email.com','ya','ya','ROLE_USER','male'),
...
CREATE TABLE `영상` (
  ...
  `영상길이` time(6) DEFAULT NULL,
  `영상등록일` date DEFAULT NULL,
  `강의번호` varchar(255) DEFAULT NULL,
  `영상소스` varchar(255) DEFAULT NULL,
...
(3,'왕초보 맨몸운동 클래스','기초부터 시작하는 맨몸운동',NULL,'2024-06-04','H',NULL,'https://i.ibb.co/51nWbCt/image.png','운동에 경험이 적은 입문자를 위한 맨몸운동 클래스입니다. 운동이 어색한 초보자분들도 기초부터 탄탄히 시작할 수 있는 첫 단추가 되어줄 과정입니다. 피트니스센터는 부담스럽고 시간이 부족해서 운동을 못했던 입문자 여러분들을 환영합니다!',3),
(4,'육쌤의 3개월 단기 홈트레이닝','바디프로필 고민중이라면?',NULL,'2024-06-04','H',NULL,'https://i.ibb.co/51nWbCt/image.png','탄탄한 경력을 가진 육선생님이 알려주는 3개월 단기 홈트레이닝, 바디프로필 이제 집에서 준비해보세요! 헬로피티와 함께라면 단기홈트를 통해 여러분도 바프에 도전할 수 있답니다 :)',0),
(5,'케틀벨 전신 홈트레이닝','좁은공간에서도 충분히 함께할 수 있는',NULL,'2024-06-04','H',NULL,'https://i.ibb.co/51nWbCt/image.png','집에서 온라인클래스로 운동을 배울 때 가장 난감했던 공간 차지! 이젠 케틀벨 운동을 통해 자리를 많이 차지하지 않으면서도 높은 웨이트 효과를 경험해보세요 케틀벨 하나면 전신운동 OK!',0),
(6,'하루 30분 홈필라테스 배우기','직장인들 하루 피로를 풀어줄',NULL,'2024-06-05','P',NULL,'https://i.ibb.co/6mSs10m/image.png','바쁘다 바빠 현대사회! 잘못된 자세로 장시간 근무하는 직장인들에게 제격인 과정입니다. 시간이 부족해도 하루 삼십분이면 괜찮아요 :) 헬로피티와 함께 필라테스를 통해 건강하게 피로를 풀고싶으신 분들 환영합니다 :)',0),
...
(9,'음악과 즐기는 필라테스 홈트','지루하고 어려운 홈트는 이제 그만',NULL,'2024-06-08','P',NULL,'https://i.ibb.co/6mSs10m/image.png','필라테스는 어렵고 지루하다고 생각하셨을 여러분을 위해 준비했습니다. 흥부자들 모여라! 음악과 함께 필라테스를 할 수 있는 즐거운 과정입니다. 입문자, 초보자 모두 함께 즐길 수 있는 가볍고 기분좋은 클래스입니다 :)',1),
(10,'하루 20분 홈 기구 필라테스','간단한 기구로 즐길 수 있는',NULL,'2024-06-09','P',NULL,'https://i.ibb.co/6mSs10m/image.png','자리 공간을 적게 차지하면서도 간단하게 즐길 수 있는 기구 필라테스 강좌입니다. 기구를 이용해 더욱 즐겁고 효과있는 필라테스를 즐겨보세요!',81),
(11,'예비엄마를 위한 임산부 필라테스','예비엄마들 모여라',NULL,'2024-06-10','P',NULL,'https://i.ibb.co/6mSs10m/image.png','예비 엄마들의 건강을 위해 헬로피티가 준비한 클래스입니다. 예비 엄마는 물론 출산을 한지 얼마 안된 초보 엄마들도 하루 잠깐의 시간을 투자하여 몸과 마음의 건강을 챙겨보시는건 어떨까요? :)',14),
(12,'하루 10분 요가 클래스','요가로 찾은 내 몸의 선',NULL,'2024-06-16','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','하루 10분으로 찾은 몸과 마음의 편안함 내 몸의 선을 찾아보고 차분한 요가 클래스를 통해 잠시의 휴식을 가져보세요. 입문자 혹은 초보자 여러분들께 적극 추천하는 헬로피티의 요가 클래스입니다.',8),
(13,'근막테라피 요가 클래스','한번의 짧은 시간으로 몸의 통증을 풀어주는',NULL,'2024-06-12','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','근육통과 같은 일상 속 몸의 통증을 요가로 극복할 수 있는 근막테라피 요가 클래스입니다. 기분좋은 습관으로 더욱 가벼워진 아침을 맞이해보세요. 변화하는 내 몸이 즐거움을 선사해줄거에요 :)',24),
...
(15,'Test','Test',NULL,'2024-06-17','H','Test','https://i.ibb.co/51nWbCt/image.png','Test',11),
(16,'요가와 명상 입문 클래스','몸과 마음의 무게 덜어내기',NULL,'2024-06-15','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','지친 일상 속 자신에게 위로를 건네주는 힐링 명상 클래스 몸과 마음의 무거운 짐을 덜어내고 잠시 집중해보세요, 하루의 고민이 눈녹듯 사라질거에요 :)',2),
(17,'하루 10분 현대인 뷰티 요가 클래스','현대인 필수 입문 코스',NULL,'2024-06-16','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','직장인, 학생도 부담없이 즐길 수 있는 10분 뷰티요가 클래스입니다. 예쁜 몸은 만들고싶지만 시간이 없어 속상했던 현대인분들 모이세요!',31),
(18,'Test','Test',NULL,'2024-06-17','H','Test','https://i.ibb.co/51nWbCt/image.png','Test',42);
...
-- Dump completed on 2024-06-20 16:31:41
