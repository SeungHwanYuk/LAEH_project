...
(3,'왕초보 맨몸운동 클래스','기초부터 시작하는 맨몸운동',NULL,'2024-06-04','H',NULL,'https://i.ibb.co/LRVSWsv/127.png','운동에 경험이 적은 입문자를 위한 맨몸운동 클래스입니다. 운동이 어색한 초보자분들도 기초부터 탄탄히 시작할 수 있는 첫 단추가 되어줄 과정입니다. 피트니스센터는 부담스럽고 시간이 부족해서 운동을 못했던 입문자 여러분들을 환영합니다!',34),
...
(9,'음악과 즐기는 필라테스 홈트','지루하고 어려운 홈트는 이제 그만',NULL,'2024-06-08','P',NULL,'https://i.ibb.co/6rpvtfY/unnamed.jpg','필라테스는 어렵고 지루하다고 생각하셨을 여러분을 위해 준비했습니다. 흥부자들 모여라! 음악과 함께 필라테스를 할 수 있는 즐거운 과정입니다. 입문자, 초보자 모두 함께 즐길 수 있는 가볍고 기분좋은 클래스입니다 :)',32),
(10,'하루 20분 홈 기구 필라테스','간단한 기구로 즐길 수 있는',NULL,'2024-06-09','P',NULL,'https://i.ibb.co/ysNfX08/maxresdefault.jpg','자리 공간을 적게 차지하면서도 간단하게 즐길 수 있는 기구 필라테스 강좌입니다. 기구를 이용해 더욱 즐겁고 효과있는 필라테스를 즐겨보세요!',200),
...
(12,'하루 10분 요가 클래스','요가로 찾은 내 몸의 선',NULL,'2024-06-16','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','하루 10분으로 찾은 몸과 마음의 편안함 내 몸의 선을 찾아보고 차분한 요가 클래스를 통해 잠시의 휴식을 가져보세요. 입문자 혹은 초보자 여러분들께 적극 추천하는 헬로피티의 요가 클래스입니다.',24),
(13,'근막테라피 요가 클래스','한번의 짧은 시간으로 몸의 통증을 풀어주는',NULL,'2024-06-12','Y',NULL,'https://i.ibb.co/Mgh1Fv7/6-1.jpg','근육통과 같은 일상 속 몸의 통증을 요가로 극복할 수 있는 근막테라피 요가 클래스입니다. 기분좋은 습관으로 더욱 가벼워진 아침을 맞이해보세요. 변화하는 내 몸이 즐거움을 선사해줄거에요 :)',26),
...
(15,'체중 감량을 위한 파워요가','우리에게 꼭 필요한 기초 코어운동',NULL,'2024-05-31','H','Test','https://i.ibb.co/MhrSgbR/2023071701753-0.jpg','오늘 요가 뭐하지?',34),
(16,'요가와 명상 입문 클래스','몸과 마음의 무게 덜어내기',NULL,'2024-06-15','Y',NULL,'https://i.ibb.co/D735NdJ/maxresdefault-1.jpg','지친 일상 속 자신에게 위로를 건네주는 힐링 명상 클래스 몸과 마음의 무거운 짐을 덜어내고 잠시 집중해보세요, 하루의 고민이 눈녹듯 사라질거에요 :)',14),
(17,'하루 10분 현대인 뷰티 요가 클래스','현대인 필수 입문 코스',NULL,'2024-06-16','Y',NULL,'https://i.ibb.co/SPHR6PD/thefunkyturtle-com-best-yoga-on-koh-tao.jpg','직장인, 학생도 부담없이 즐길 수 있는 10분 뷰티요가 클래스입니다. 예쁜 몸은 만들고싶지만 시간이 없어 속상했던 현대인분들 모이세요!',83),
...
-- Dump completed on 2024-06-27 17:23:37
