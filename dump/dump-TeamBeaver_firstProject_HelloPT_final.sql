...
(4,'로그인을 하셨다면 메인페이지 \'시작하기\' 버튼을 누르시면 구독하신 마이페이창으로 이동이 되요! 두번째 방법은 상단의 마이페이지에 들어 오시면 회원님의 강의를 보실수 있어요.','2024-06-21 12:50:06.663063','구독 내역을 확인하고 싶어요!',3,'admin',NULL),
...
(9,'너무 좋아여','2024-06-21 16:06:49.980244','왜 모든 강의가 무료인가요?',2,'bobo','HelloPT는 수익을 창출하지 않습니다!'),
(10,'강의선생님이 다른데 환불해주세요','2024-06-21 17:03:03.594718','썸네일이랑 달라요',2,'bobo','안됩니다'),
(11,'왜 강아지 무시함?','2024-06-21 17:10:50.857673','강아지는요?',2,'bobo','둘다 귀엽습니다'),
(14,'ㅎㅎ','2024-06-21 17:23:52.341927','고양이는 귀여워',2,'bobo','인정입니다'),
(16,'탈퇴하고 싶은데....못찾겠어요','2024-06-21 17:24:27.070224','회원탈퇴 기능은 없나요?',2,'bobo','나가는 문은 없습니다.'),
(21,'팀 비버 화이팅!','2024-06-25 09:05:24.995670','팀 비버 화이팅',1,'yami',NULL),
(22,'자유게시판 테스트 입니다','2024-06-25 09:07:36.622703','자유게시판 테스트 입니다',1,'yami',NULL),
(23,'ㅎㅇㅎㅇㅎㅇㅎㅇ','2024-06-25 09:07:47.714066','안녕하세요!',1,'yami',NULL),
(24,'ㅎㅎ','2024-06-25 09:07:52.331350','배고프다',1,'yami',NULL),
(25,'test','2024-06-25 09:07:56.265802','test',1,'yami',NULL),
(32,'뻥이야','2024-06-28 13:18:14.683322','배고프다',1,'yami',NULL);
...
(39,'새로운 첫 시작을 위한 요가','https://youtu.be/Zk_qUVb-ESI?si=eSdQ7LlRiKvrnVpO',NULL,'제목 테스트',NULL,14),
(40,'체중 감량을 위한 파워요가','https://youtu.be/pVo1eS-8-yw?si=yWlFHB6ohVfdQFw3',NULL,'제목 테스트',NULL,15),
...
(702,'2024-06-27 19:08:40.062700','야옹','catcat');
...
('catcat','2024-06-27 19:06:18.419366','$2a$10$JtduYEy23PgNuAU2JhaiDOxLATfCuC2v1zIN3/2bx3j8Hj7dKkDbK','123123123123','cat','cat','cat!','ROLE_USER','female'),
...
(1,'하루 한시간 맨몸운동 클래스','변화가 눈으로 확인되는 고강도 홈트레이닝','00:00:01.000000','2024-05-01','H','1','https://i.ibb.co/51nWbCt/image.png','빠른 변화가 필요하시거나 평소 고강도의 운동을 즐기시는 분들에게 추천하는 과정입니다.\n 맨몸운동으로 강도는 강하지만 집에서도 충분히 즐길 수 있는 클래스입니다. \n 다가올 여름을 위해 단기 몸만들기를 원하시는 분들께 강추드립니다 :)',14),
(2,'9가지 대표운동 킨스트레치','스쿼트 푸쉬업 달리기까지 한큐에',NULL,'2024-06-02','H',NULL,'https://i.ibb.co/Fmz8Bjv/maxresdefault-4.jpg','운동을 시작하기에 앞서 운동 동작에 필요한 관절의 움직임을 세세하게 배울 수 있는 클래스입니다. 우리 몸의 관절을 이해하고 움직임을 조절하는 법을 배우며 유연성을 늘려보아요! 전문가가 아닌 일반인들도 운동 동작을 매끄럽게 이해할 수 있습니다 :)',14),
(3,'왕초보 맨몸운동 클래스','기초부터 시작하는 맨몸운동',NULL,'2024-06-04','H',NULL,'https://i.ibb.co/LRVSWsv/127.png','운동에 경험이 적은 입문자를 위한 맨몸운동 클래스입니다. 운동이 어색한 초보자분들도 기초부터 탄탄히 시작할 수 있는 첫 단추가 되어줄 과정입니다. 피트니스센터는 부담스럽고 시간이 부족해서 운동을 못했던 입문자 여러분들을 환영합니다!',43),
(4,'육쌤의 3개월 단기 홈트레이닝','바디프로필 고민중이라면?',NULL,'2024-06-04','H',NULL,'https://i.ibb.co/xDkgCT1/original-1.jpg','탄탄한 경력을 가진 육선생님이 알려주는 3개월 단기 홈트레이닝, 바디프로필 이제 집에서 준비해보세요! 헬로피티와 함께라면 단기홈트를 통해 여러분도 바프에 도전할 수 있답니다 :)',1),
(5,'케틀벨 전신 홈트레이닝','좁은공간에서도 충분히 함께할 수 있는',NULL,'2024-06-04','H',NULL,'https://i.ibb.co/PxTf8zh/20210522011115280rpqx.jpg','집에서 온라인클래스로 운동을 배울 때 가장 난감했던 공간 차지! 이젠 케틀벨 운동을 통해 자리를 많이 차지하지 않으면서도 높은 웨이트 효과를 경험해보세요 케틀벨 하나면 전신운동 OK!',7),
(6,'하루 30분 홈필라테스 배우기','직장인들 하루 피로를 풀어줄',NULL,'2024-06-05','P',NULL,'https://i.ibb.co/XFcGHxS/image.jpg','바쁘다 바빠 현대사회! 잘못된 자세로 장시간 근무하는 직장인들에게 제격인 과정입니다. 시간이 부족해도 하루 삼십분이면 괜찮아요 :) 헬로피티와 함께 필라테스를 통해 건강하게 피로를 풀고싶으신 분들 환영합니다 :)',3),
(7,'체형교정 다이어트 필라테스','체형고정이 고민인 학생, 직장인을 위한',NULL,'2024-06-06','P',NULL,'https://i.ibb.co/JqC619c/image.png','책상에 오래 있을 수 밖에 없는 직장인, 학생분들 위해 준비했습니다! 내 체형에 맞는 자세를 알아보고 함께 배워볼 수 있는 클래스입니다. 바른 체형과 자세만큼 중요한 건 없습니다, 지금 바로 시작해보세요!',10),
(8,'매일매일 10분 홈스트레칭','출근전, 퇴근후 간단하게',NULL,'2024-06-07','P',NULL,'https://i.ibb.co/L1SQXc8/original-2.jpg','외출 전에도, 외출 시 틈틈히, 외출 후에도 10분씩 간단하게 시작하는 스트레칭 바깥에서 항상 긴장되어있는 내 몸의 근육을 위해 지금 시작해보세요 :)',3),
(9,'음악과 즐기는 필라테스 홈트','지루하고 어려운 홈트는 이제 그만',NULL,'2024-06-08','P',NULL,'https://i.ibb.co/6rpvtfY/unnamed.jpg','필라테스는 어렵고 지루하다고 생각하셨을 여러분을 위해 준비했습니다. 흥부자들 모여라! 음악과 함께 필라테스를 할 수 있는 즐거운 과정입니다. 입문자, 초보자 모두 함께 즐길 수 있는 가볍고 기분좋은 클래스입니다 :)',33),
(10,'하루 20분 홈 기구 필라테스','간단한 기구로 즐길 수 있는',NULL,'2024-06-09','P',NULL,'https://i.ibb.co/ysNfX08/maxresdefault.jpg','자리 공간을 적게 차지하면서도 간단하게 즐길 수 있는 기구 필라테스 강좌입니다. 기구를 이용해 더욱 즐겁고 효과있는 필라테스를 즐겨보세요!',230),
(11,'예비엄마를 위한 임산부 필라테스','예비엄마들 모여라',NULL,'2024-06-10','P',NULL,'https://i.ibb.co/fQn7zW5/1.jpg','예비 엄마들의 건강을 위해 헬로피티가 준비한 클래스입니다. 예비 엄마는 물론 출산을 한지 얼마 안된 초보 엄마들도 하루 잠깐의 시간을 투자하여 몸과 마음의 건강을 챙겨보시는건 어떨까요? :)',34),
(12,'하루 10분 요가 클래스','요가로 찾은 내 몸의 선',NULL,'2024-06-16','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','하루 10분으로 찾은 몸과 마음의 편안함 내 몸의 선을 찾아보고 차분한 요가 클래스를 통해 잠시의 휴식을 가져보세요. 입문자 혹은 초보자 여러분들께 적극 추천하는 헬로피티의 요가 클래스입니다.',27),
(13,'근막테라피 요가 클래스','한번의 짧은 시간으로 몸의 통증을 풀어주는',NULL,'2024-06-12','Y',NULL,'https://i.ibb.co/Mgh1Fv7/6-1.jpg','근육통과 같은 일상 속 몸의 통증을 요가로 극복할 수 있는 근막테라피 요가 클래스입니다. 기분좋은 습관으로 더욱 가벼워진 아침을 맞이해보세요. 변화하는 내 몸이 즐거움을 선사해줄거에요 :)',27),
(14,'하루 10분 아로마 요가 4주 플랜','지친 내 몸, 힐링이 필요하다면?',NULL,'2024-06-13','Y',NULL,'https://i.ibb.co/km9CL9J/original.jpg','하루 10분으로 즐기는 아로마테라피, 아로마요가 4주 플랜 클래스입니다. 아로마는 몸과 마음을 진정시켜주고 근육을 이완시켜줍니다. 지친 일상 속 내 몸에게 선물해보세요!',3),
(15,'체중 감량을 위한 파워요가','우리에게 꼭 필요한 기초 코어운동',NULL,'2024-05-31','H','Test','https://i.ibb.co/MhrSgbR/2023071701753-0.jpg','오늘 요가 뭐하지?',39),
(16,'요가와 명상 입문 클래스','몸과 마음의 무게 덜어내기',NULL,'2024-06-15','Y',NULL,'https://i.ibb.co/D735NdJ/maxresdefault-1.jpg','지친 일상 속 자신에게 위로를 건네주는 힐링 명상 클래스 몸과 마음의 무거운 짐을 덜어내고 잠시 집중해보세요, 하루의 고민이 눈녹듯 사라질거에요 :)',16),
(17,'하루 10분 현대인 뷰티 요가 클래스','현대인 필수 입문 코스',NULL,'2024-06-16','Y',NULL,'https://i.ibb.co/SPHR6PD/thefunkyturtle-com-best-yoga-on-koh-tao.jpg','직장인, 학생도 부담없이 즐길 수 있는 10분 뷰티요가 클래스입니다. 예쁜 몸은 만들고싶지만 시간이 없어 속상했던 현대인분들 모이세요!',88),
(18,'넓은어깨 필수운동 덤벨 숄더프레스','절대 안 커지는 어깨, 이 운동이면 커집니다!',NULL,'2024-06-17','H','Test','https://i.ibb.co/5n2HmbT/maxresdefault-2.jpg','어깨 부위별 타겟법',90);
...
-- Dump completed on 2024-06-28 15:08:50
