...
(1,'시작하기버튼을 누르시면 강의 선택창으로 안내해드려요! 들어가셔서 원하시는 강좌를 들어보세요!','2024-06-21 12:44:07.593322','이용 시 수강 가능한 클래스를 확인하고 싶어요!',3,'',NULL),
(2,'CLASS101+ 구독을 결제했지만, 결제한 계정이 아닌 다른 계정에서 이용을 원하시나요? 그렇다면 다음 방법을 확인해주세요! 이용하고자 하는 계정이 이미 있는 경우, 안타깝게도 구독권은 이전이 불가하기 때문에 재가입 구독을 해주셔야해요😢','2024-06-21 12:46:18.722802','다른 계정에서 이용하고 싶어요',3,'',NULL),
(3,'최초 회원가입 시 클래스101 알림톡으로 [회원가입 정보]를 보내드리고 있어요! 번거로우시겠지만 카카오톡 알림톡을 통해 ID와 로그인 정보 확인 부탁드립니다. 만약 알림톡에서 확인이 불가하다면 번거로우시더라도 고객센터를 통해 문의해주시기 바랍니다.신속하고 친절한 안내 드리겠습니다.','2024-06-21 12:47:46.630823','가입한 계정을 찾을 수 없어요',3,'',NULL),
(4,'로그인을 하셨다면 메인페이지 \'시작하기\' 버튼을 누르시면 구독하신 마이페이창으로 이동이 되요! 두번째 방법은 상단의 마이페이지에 들어 오시면 회원님의 강의를 보실수 있어요.','2024-06-21 12:50:06.663063','구독 내역을 확인하고 싶어요!',3,'',NULL),
(5,'그룹 플랜은 구독 공유형 서비스입니다. 그룹 플랜으로 헬로피티 구독을 시작하시면, 타 계정을 초대하여 함께 구독 서비스를 이용하실 수 있습니다.','2024-06-21 12:51:24.904703','플랜 서비스',3,'',NULL),
(6,'이런 느낌 처음이야.','2024-06-21 14:02:39.362163','뭐에요',2,'',NULL),
(9,'fsdfsdf','2024-06-21 16:06:49.980244','dfsdfds',2,'',NULL),
(10,'333','2024-06-21 17:03:03.594718','333',2,'',NULL),
(11,'123123','2024-06-21 17:10:50.857673','123123',2,'',NULL),
(12,'123123','2024-06-21 17:11:11.642605','123123',1,'',NULL),
(13,'asdasdasd','2024-06-21 17:11:33.675263','asdasd',1,'',NULL),
(14,'34q3yq34yq34y','2024-06-21 17:23:52.341927','123123q34tyq',2,'',NULL),
(15,'135153135','2024-06-21 17:24:13.325118','2135135',1,'',NULL),
(16,'135135','2024-06-21 17:24:27.070224','135135##########',2,'',NULL),
(17,'123123','2024-06-25 09:01:57.475073','test',1,'',NULL),
(18,'test','2024-06-25 09:02:09.492806','test',1,'',NULL),
(19,'test','2024-06-25 09:02:31.107205','test',1,'',NULL),
(20,'test','2024-06-25 09:05:24.075400','test',1,'',NULL),
...
(27,'test','2024-06-25 09:08:04.688827','test',1,'yami',NULL),
(28,'test','2024-06-25 09:08:08.186620','test',1,'yami',NULL),
(29,'test','2024-06-25 09:08:11.554129','test',1,'yami',NULL),
(30,'test','2024-06-25 09:08:14.959932','test',1,'yami',NULL),
(31,'test','2024-06-25 09:08:20.176378','test',1,'yami',NULL);
...
(1,'123','123',NULL,'123',NULL,1),
(2,'123','123',NULL,'123',NULL,1),
(3,'123','123',NULL,'123',NULL,2);
...
('admin','2024-06-21 14:07:21.479973','$2a$10$zSovu637sUdvZuVf/.dstukplEKBY1uTq2wLBj/XQHydlX6yxJz4K','0101010101','admin@email.com','admin','admin','ROLE_ADMIN','male'),
...
('yami','2024-06-20 16:19:21.580774','$2a$10$MA4hFL0lRJiuZ/7I3X.pBuituH2ss/e/3HHBJ/OnetOGXIhbbX4PC','123','ya@email.com','ya','ya','ROLE_TEACHER','male'),
...
(1,'하루 한시간 맨몸운동 클래스','변화가 눈으로 확인되는 고강도 홈트레이닝','00:00:01.000000','2024-06-01','H','1','https://i.ibb.co/51nWbCt/image.png','빠른 변화가 필요하시거나 평소 고강도의 운동을 즐기시는 분들에게 추천하는 과정입니다.\n 맨몸운동으로 강도는 강하지만 집에서도 충분히 즐길 수 있는 클래스입니다. \n 다가올 여름을 위해 단기 몸만들기를 원하시는 분들께 강추드립니다 :)',12),
(2,'9가지 대표운동 킨스트레치','스쿼트 푸쉬업 달리기까지 한큐에',NULL,'2024-06-02','H',NULL,'https://i.ibb.co/51nWbCt/image.png','운동을 시작하기에 앞서 운동 동작에 필요한 관절의 움직임을 세세하게 배울 수 있는 클래스입니다. 우리 몸의 관절을 이해하고 움직임을 조절하는 법을 배우며 유연성을 늘려보아요! 전문가가 아닌 일반인들도 운동 동작을 매끄럽게 이해할 수 있습니다 :)',7),
(3,'왕초보 맨몸운동 클래스','기초부터 시작하는 맨몸운동',NULL,'2024-06-04','H',NULL,'https://i.ibb.co/51nWbCt/image.png','운동에 경험이 적은 입문자를 위한 맨몸운동 클래스입니다. 운동이 어색한 초보자분들도 기초부터 탄탄히 시작할 수 있는 첫 단추가 되어줄 과정입니다. 피트니스센터는 부담스럽고 시간이 부족해서 운동을 못했던 입문자 여러분들을 환영합니다!',14),
...
(5,'케틀벨 전신 홈트레이닝','좁은공간에서도 충분히 함께할 수 있는',NULL,'2024-06-04','H',NULL,'https://i.ibb.co/51nWbCt/image.png','집에서 온라인클래스로 운동을 배울 때 가장 난감했던 공간 차지! 이젠 케틀벨 운동을 통해 자리를 많이 차지하지 않으면서도 높은 웨이트 효과를 경험해보세요 케틀벨 하나면 전신운동 OK!',1),
...
(7,'체형교정 다이어트 필라테스','체형고정이 고민인 학생, 직장인을 위한',NULL,'2024-06-06','P',NULL,'https://i.ibb.co/6mSs10m/image.png','책상에 오래 있을 수 밖에 없는 직장인, 학생분들 위해 준비했습니다! 내 체형에 맞는 자세를 알아보고 함께 배워볼 수 있는 클래스입니다. 바른 체형과 자세만큼 중요한 건 없습니다, 지금 바로 시작해보세요!',1),
(8,'매일매일 10분 홈스트레칭','출근전, 퇴근후 간단하게',NULL,'2024-06-07','P',NULL,'https://i.ibb.co/6mSs10m/image.png','외출 전에도, 외출 시 틈틈히, 외출 후에도 10분씩 간단하게 시작하는 스트레칭 바깥에서 항상 긴장되어있는 내 몸의 근육을 위해 지금 시작해보세요 :)',0),
(9,'음악과 즐기는 필라테스 홈트','지루하고 어려운 홈트는 이제 그만',NULL,'2024-06-08','P',NULL,'https://i.ibb.co/6mSs10m/image.png','필라테스는 어렵고 지루하다고 생각하셨을 여러분을 위해 준비했습니다. 흥부자들 모여라! 음악과 함께 필라테스를 할 수 있는 즐거운 과정입니다. 입문자, 초보자 모두 함께 즐길 수 있는 가볍고 기분좋은 클래스입니다 :)',11),
(10,'하루 20분 홈 기구 필라테스','간단한 기구로 즐길 수 있는',NULL,'2024-06-09','P',NULL,'https://i.ibb.co/6mSs10m/image.png','자리 공간을 적게 차지하면서도 간단하게 즐길 수 있는 기구 필라테스 강좌입니다. 기구를 이용해 더욱 즐겁고 효과있는 필라테스를 즐겨보세요!',109),
(11,'예비엄마를 위한 임산부 필라테스','예비엄마들 모여라',NULL,'2024-06-10','P',NULL,'https://i.ibb.co/6mSs10m/image.png','예비 엄마들의 건강을 위해 헬로피티가 준비한 클래스입니다. 예비 엄마는 물론 출산을 한지 얼마 안된 초보 엄마들도 하루 잠깐의 시간을 투자하여 몸과 마음의 건강을 챙겨보시는건 어떨까요? :)',16),
(12,'하루 10분 요가 클래스','요가로 찾은 내 몸의 선',NULL,'2024-06-16','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','하루 10분으로 찾은 몸과 마음의 편안함 내 몸의 선을 찾아보고 차분한 요가 클래스를 통해 잠시의 휴식을 가져보세요. 입문자 혹은 초보자 여러분들께 적극 추천하는 헬로피티의 요가 클래스입니다.',12),
...
(14,'하루 10분 아로마 요가 4주 플랜','지친 내 몸, 힐링이 필요하다면?',NULL,'2024-06-13','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','하루 10분으로 즐기는 아로마테라피, 아로마요가 4주 플랜 클래스입니다. 아로마는 몸과 마음을 진정시켜주고 근육을 이완시켜줍니다. 지친 일상 속 내 몸에게 선물해보세요!',1),
(15,'Test','Test',NULL,'2024-06-17','H','Test','https://i.ibb.co/51nWbCt/image.png','Test',18),
(16,'요가와 명상 입문 클래스','몸과 마음의 무게 덜어내기',NULL,'2024-06-15','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','지친 일상 속 자신에게 위로를 건네주는 힐링 명상 클래스 몸과 마음의 무거운 짐을 덜어내고 잠시 집중해보세요, 하루의 고민이 눈녹듯 사라질거에요 :)',5),
(17,'하루 10분 현대인 뷰티 요가 클래스','현대인 필수 입문 코스',NULL,'2024-06-16','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','직장인, 학생도 부담없이 즐길 수 있는 10분 뷰티요가 클래스입니다. 예쁜 몸은 만들고싶지만 시간이 없어 속상했던 현대인분들 모이세요!',52),
(18,'Test','Test',NULL,'2024-06-17','H','Test','https://i.ibb.co/51nWbCt/image.png','Test',58);
...
-- Dump completed on 2024-06-25 10:19:16
