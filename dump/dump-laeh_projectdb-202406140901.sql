...
('1','YOGA',NULL,'yam','yami2024'),
('2','HEALTH',NULL,'BOBO','bobo'),
('3','PILATES',NULL,'byul','star0717');
...
('H',NULL,'HEALTH','헬스가 좋아 왕좋아','1','헬창으로 사는 방법',NULL),
('P',NULL,'PILATES','필라테스는 모야?','3','나도 잘 몰?루',NULL),
('Y',NULL,'YOGA','요가가 좋아 짱좋아','2','요가는 운동인가 체조인가',NULL);
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `구독` (
  `구독번호` varchar(255) NOT NULL,
  `구독시작일` date DEFAULT NULL,
  `강의번호` varchar(255) DEFAULT NULL,
  `사용자아이디` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`구독번호`),
  KEY `FK68b1ydwdo8g53l2w63lvijhjc` (`강의번호`),
  KEY `FKm2rryxn25xkfsvl5i1y985ius` (`사용자아이디`),
  CONSTRAINT `FK68b1ydwdo8g53l2w63lvijhjc` FOREIGN KEY (`강의번호`) REFERENCES `강의` (`강의번호`),
...
('bobo','2024-06-10 16:15:30.311803','$2a$10$9LyGbQgsF80Rb.bPMpGUFuOUbhMo0WZsm9DuDXSFyOOVZ20a47mIO','012121212','iambobo@email.com','bobo','bobo','ROLE_USER','WOMEN'),
('hongbao','2024-06-07 16:46:48.995679','$2a$10$4wD9bEn4bErMxExi/ztSreKyZ6YwmoQktFsQ5t0IsCKABg4kv6Dae','012121212','iampanda@email.com','hongbao','Hong','ROLE_USER','MAN'),
...
('yami2024','2024-06-10 15:23:37.012834','$2a$10$jL7NpYGwI35a8fTBtLNkme1xGs3zNPTdDbwQjJ8DgvkjFAb7nLFvm','012121212','iamcat@email.com','yami2024','yam','ROLE_TEACHER','MAN');
...
('A','하루 한시간 맨몸운동 클래스','변화가 눈으로 확인되는 고강도 홈트레이닝',NULL,NULL,'H',NULL,NULL),
('B','9가지 대표운동 킨스트레치','스쿼트 푸쉬업 달리기까지 한큐에',NULL,NULL,'H',NULL,NULL),
('C','왕초보 맨몸운동 클래스','기초부터 시작하는 맨몸운동',NULL,NULL,'H',NULL,NULL),
('D','육쌤의 3개월 단기 홈트레이닝','바디프로필 고민중이라면?',NULL,NULL,'H',NULL,NULL),
('E','케틀벨 전신 홈트레이닝','좁은공간에서도 충분히 함께할 수 있는',NULL,NULL,'H',NULL,NULL),
('F','하루 30분 홈필라테스 배우기','직장인들 하루 피로를 풀어줄',NULL,NULL,'P',NULL,NULL),
('G','체형교정 다이어트 필라테스','체형고정이 고민인 학생, 직장인을 위한',NULL,NULL,'P',NULL,NULL),
('H','매일매일 10분 홈스트레칭','출근전, 퇴근후 간단하게',NULL,NULL,'P',NULL,NULL),
('I','음악과 즐기는 필라테스 홈트','지루하고 어려운 홈트는 이제 그만',NULL,NULL,'P',NULL,NULL),
('J','하루 20분 홈 기구 필라테스','간단한 기구로 즐길 수 있는',NULL,NULL,'P',NULL,NULL),
('K','예비엄마를 위한 임산부 필라테스','예비엄마들 모여라',NULL,NULL,'P',NULL,NULL),
('L','하루 10분 요가 클래스','요가로 찾은 내 몸의 선',NULL,NULL,'Y',NULL,NULL),
('M','근막테라피 요가 클래스','한번의 짧은 시간으로 몸의 통증을 풀어주는',NULL,NULL,'Y',NULL,NULL),
('N','하루 10분 아로마 요가 4주 플랜','지친 내 몸, 힐링이 필요하다면?',NULL,NULL,'Y',NULL,NULL),
('O','왕초보 전용 챌린지 요가 클래스','요가 왕초보들 모여라!',NULL,NULL,'Y',NULL,NULL),
('P','요가와 명상 입문 클래스','몸과 마음의 무게 덜어네기',NULL,NULL,'Y',NULL,NULL),
('Q','하루 10분 현대인 뷰티 요가 클래스','현대인 필수 입문 코스',NULL,NULL,'Y',NULL,NULL);
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `진도율` (
  `진도율고유번호` int(11) NOT NULL,
  `저장시점` int(11) DEFAULT NULL,
  `구독번호` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`진도율고유번호`),
...
-- Dump completed on 2024-06-14  9:01:48
