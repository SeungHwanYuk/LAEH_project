...
(2,'9가지 대표운동 킨스트레치','스쿼트 푸쉬업 달리기까지 한큐에',NULL,'2024-06-02','H',NULL,'https://i.ibb.co/Fmz8Bjv/maxresdefault-4.jpg','운동을 시작하기에 앞서 운동 동작에 필요한 관절의 움직임을 세세하게 배울 수 있는 클래스입니다. 우리 몸의 관절을 이해하고 움직임을 조절하는 법을 배우며 유연성을 늘려보아요! 전문가가 아닌 일반인들도 운동 동작을 매끄럽게 이해할 수 있습니다 :)',12),
(3,'왕초보 맨몸운동 클래스','기초부터 시작하는 맨몸운동',NULL,'2024-06-04','H',NULL,'https://i.ibb.co/LRVSWsv/127.png','운동에 경험이 적은 입문자를 위한 맨몸운동 클래스입니다. 운동이 어색한 초보자분들도 기초부터 탄탄히 시작할 수 있는 첫 단추가 되어줄 과정입니다. 피트니스센터는 부담스럽고 시간이 부족해서 운동을 못했던 입문자 여러분들을 환영합니다!',37),
...
(10,'하루 20분 홈 기구 필라테스','간단한 기구로 즐길 수 있는',NULL,'2024-06-09','P',NULL,'https://i.ibb.co/ysNfX08/maxresdefault.jpg','자리 공간을 적게 차지하면서도 간단하게 즐길 수 있는 기구 필라테스 강좌입니다. 기구를 이용해 더욱 즐겁고 효과있는 필라테스를 즐겨보세요!',205),
...
(12,'하루 10분 요가 클래스','요가로 찾은 내 몸의 선',NULL,'2024-06-16','Y',NULL,'https://i.ibb.co/XtCkB8T/image.png','하루 10분으로 찾은 몸과 마음의 편안함 내 몸의 선을 찾아보고 차분한 요가 클래스를 통해 잠시의 휴식을 가져보세요. 입문자 혹은 초보자 여러분들께 적극 추천하는 헬로피티의 요가 클래스입니다.',25),
...
(16,'요가와 명상 입문 클래스','몸과 마음의 무게 덜어내기',NULL,'2024-06-15','Y',NULL,'https://i.ibb.co/D735NdJ/maxresdefault-1.jpg','지친 일상 속 자신에게 위로를 건네주는 힐링 명상 클래스 몸과 마음의 무거운 짐을 덜어내고 잠시 집중해보세요, 하루의 고민이 눈녹듯 사라질거에요 :)',15),
(17,'하루 10분 현대인 뷰티 요가 클래스','현대인 필수 입문 코스',NULL,'2024-06-16','Y',NULL,'https://i.ibb.co/SPHR6PD/thefunkyturtle-com-best-yoga-on-koh-tao.jpg','직장인, 학생도 부담없이 즐길 수 있는 10분 뷰티요가 클래스입니다. 예쁜 몸은 만들고싶지만 시간이 없어 속상했던 현대인분들 모이세요!',84),
...
-- Dump completed on 2024-06-27 20:06:13
